  ...
  return (
    <div className="project-section" id="projects">
      ...
      <div className="project-container">
        ...
        <div className="fifty">
          <a
            href="https://github.com/JoseJaramillo04/productinventorytracker"
            className="project-title title-second"
          >
      ...
      <div className="project-container">
        <div className="fifty">
          <a
            href="https://github.com/JoseJaramillo04/MyFlick"
      ...
      <div className="project-container">
        <div className="fifty">
          <a
            href="https://github.com/JoseJaramillo04/Raising-Canes-Survey-Filler-Bot"
            className="project-title"
          >
            Cane's Chicken Python Bot
          </a>
          /h4
          <p className="project-desc">
            A{" "}
